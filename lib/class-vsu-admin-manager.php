...
# Outputters
        ...
        public function settings_page_header() {
			...
			$url = VSU_WEBSITE;
			$headerDiv = "<p class='tac'>Need more features and translate into your own language?</p>";
			$pro_vsu_btn = "<a href='$url' target='_blank' class='sign-up-pro'></a>";
			$out = $headerDiv.$pro_vsu_btn;
			
            $img_url = VSU_ASSETS_ADMIN_URI . 'img/Logo-Dark-web.png';
...
# Field Outputters
        ...
        public function license_field( $section_id, $field_id, $label = '' ) {
			...
			$vsu_website = esc_attr( VSU_WEBSITE );
			$help_text2 = sprintf( 
                            __( 'Having trouble activating our plugin? Try our new version of %sViral Sign Ups%s here.', 'viralsignups' ), 
                            "<a href='$vsu_website' target='_blank'>", "</a>" );
            $out .= "<p class='vsu-admin-field-desc'>$help_text2</p>";
