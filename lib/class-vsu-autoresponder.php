...
//            $unsub_text = __( 'To stop receiving emails about sign ups, click here.', 'viralsignups' );
            ...
            $website_name =  VSU_WEBSITE_NAME;
			$powered_by = sprintf( 
                __( "%s$website_name%s", 'viralsignups' ), 
                "<a style='text-decoration:none;' href='$website_url' target='_blank' title='ViralSignUps.com'>", "</a>"
            );
            $out = '<tr class="">
                        <td>
...
//                                    <td width="65%" style="padding: 10px 6px 6px 16px;"><p style="margin: 0; text-align: left; font: 300 10px/20px Lato, Arial, sans-serif; color: #39455b;">' . $unsub_text . '</p></td>
                                    '<td style="padding: 0 16px 6px 6px;"><p style="margin: 0; text-align: right; font: 300 12px/20px Lato, Arial, sans-serif; color: #39455b;" class="vsu-powered-by">' . $powered_by . '</p></td>
                                </tr>
                            </table>
                        </td>
                    </tr>';
